    ...
    return (
      <>
        {canCreateProject ? (
          ...
          <p>
            {t(
              'public~OpenShift helps you quickly develop, host, and scale applications. To get started, you&lsquo;ll need a project. Currently, you can&lsquo;t create or access any projects.',
            )}
            {!createProjectMessage &&
              t('public~ You&lsquo;ll need to contact a cluster administrator for help.')}
          </p>
        )}
        {createProjectMessage && (
        ...
        <p>
          {t('public~To learn more, visit the OpenShift  ')}
          <ExternalLink href={openshiftHelpBase} text={t('public~documentation')} />.
        </p>
        <p>
          {t('public~Download the ')}
          <Link to="/command-line-tools">{t('public~command-line tools')}</Link>
        </p>
        {canCreateProject && (
